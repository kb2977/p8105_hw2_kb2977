...
* `r round(mean(transit_data$entry == "TRUE" & transit_data$vending == "NO"), digits = 4)` of station entrances and exits without vending are allowed entrance.
...
3. What state is observed the most?
    + `r max(brfss_data$locationabbr)` is observed the most
